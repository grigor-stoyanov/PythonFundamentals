...
def render_list_task_view():
    ...
    Button(tk, text="Edit", width=10, command=lambda: render_edit_task(eval(dropdown.get())), bg="yellow", fg="black",
...
def render_edit_task(to_edit):
    ...
    Button(tk, text="Edit", bg="Yellow", fg="white", font="16",
